 ...
 * Proporciona métodos para agregar, actualizar, eliminar y consultar datos de empleados.
 * 
 * @author Edgar
 */
public class EmpleadoService {
    ...
    /**
     * Calcula y actualiza el sueldo de un empleado en función de sus horas trabajadas.
     * 
     * @param empleado Objeto Empleado.
     * @param id Identificador del empleado.
